...
public class HiveSQL {
     ...
     */
    public final static String SQL_ODS_TO_DWD_EVENT = String.format("INSERT OVERWRITE TABLE dwd_base_event_log\n" +
                    "PARTITION(dt='%s')\n" +
                    "SELECT\n" +
     ...
     */
    public final static String SQL_ODS_TO_DWD_COMMENT_EVENT = String.format("INSERT overwrite TABLE dwd_comment_log PARTITION (dt = '%s') SELECT\n" +
                    "\tmid_id,\n" +
                    "\tuser_id,\n" +
                    "\tversion_code,\n" +
                    "\tversion_name,\n" +
     ...
     */
    public final static String SQL_ODS_TO_DWD_START = String.format("INSERT OVERWRITE TABLE dwd_start_log\n" +
                    "PARTITION (dt='%s')\n" +
                    "SELECT\n" +
     ...
     */
    public final static String SQL_DWD_TO_DWS_START = String.format("INSERT overwrite TABLE dws_uv_detail_daycount PARTITION (dt = '%s') SELECT\n" +
                    "\tmid_id,\n" +
     ...
     */
    public final static String SQL_DWS_TO_DWT_START = String.format("INSERT overwrite TABLE dwt_uv_topic SELECT\n" +
     ...
     * ADS层 数据应用层 -活跃设备数
     */
    public final static String SQL_DWT_TO_ADS_ACTIVEDEVICES_START = String.format("\n" +
     ...
     * ADS层 数据应用层 -连续活跃设备数
     */
    public final static String SQL_DWT_TO_ADS_CONTINUOUS_ACTIVE_DEVICES_START = String.format("\n" +
     ...
     */
    public final static String SQL_DWT_TO_ADS_THREE_CONSECUTIVE_WEEKS_START = String.format("\n" +
     ...
     * ADS层 数据应用层 -每日用户留存情况
     */
    public final static String SQL_DWT_TO_ADS_DAILY_USER_RETENTION_STATUS_START = String.format("\n" +
     ...
     * ADS层 数据应用层 -流失用户数
     */
    public final static String SQL_DWT_TO_ADS_LOST_USERS_START = String.format("\n" +
     ...
     */
    public final static String SQL_DWT_TO_ADS_NUMBER_OF_NEW_DEVICE_ADDED_DAILY_START = String.format("\n" +
     ...
     * ADS层 数据应用层 -沉默用户数
     */
    public final static String SQL_DWT_TO_ADS_NUMBER_OF_SILENT_USERS_START = String.format("\n" +
     ...
     * ADS层 数据应用层 -本周回流用户数
     */
    public final static String SQL_DWT_TO_ADS_RETURNING_USERS_START = String.format("\n" +
